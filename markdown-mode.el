...
(defconst markdown-header-delimiter-properties
  '(face markdown-header-delimiter-face invisible markdown-markup)
  "List of properties and values to apply to atx header delimiters.")

(defconst markdown-header-rule-properties
  '(face markdown-header-rule-face invisible markdown-markup)
  "List of properties and values to apply to setext header rules.")
...
(defvar markdown-mode-font-lock-keywords-basic
  `((markdown-match-yaml-metadata-begin . ((1 markdown-markup-face)))
    ...
    (markdown-match-heading-1-setext . ((1 markdown-header-face-1)
                                        (2 markdown-header-rule-properties)))
    (markdown-match-heading-2-setext . ((1 markdown-header-face-2)
                                        (3 markdown-header-rule-properties)))
    (markdown-match-heading-6-atx . ((4 markdown-header-delimiter-properties)
                                     (5 markdown-header-face-6)
                                     (6 markdown-header-delimiter-properties)))
    (markdown-match-heading-5-atx . ((4 markdown-header-delimiter-properties)
                                     (5 markdown-header-face-5)
                                     (6 markdown-header-delimiter-properties)))
    (markdown-match-heading-4-atx . ((4 markdown-header-delimiter-properties)
                                     (5 markdown-header-face-4)
                                     (6 markdown-header-delimiter-properties)))
    (markdown-match-heading-3-atx . ((4 markdown-header-delimiter-properties)
                                     (5 markdown-header-face-3)
                                     (6 markdown-header-delimiter-properties)))
    (markdown-match-heading-2-atx . ((4 markdown-header-delimiter-properties)
                                     (5 markdown-header-face-2)
                                     (6 markdown-header-delimiter-properties)))
    (markdown-match-heading-1-atx . ((4 markdown-header-delimiter-properties)
